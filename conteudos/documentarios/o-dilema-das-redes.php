...
<title>Análise de "O Dilema das Redes" - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>O Dilema das Redes</h2>
            <p>"O Dilema das Redes" destaca os perigos das mídias sociais, expondo seus efeitos manipulativos e os riscos à privacidade e à sociedade.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 28/04/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/O-dilema-das-redes-capa.jpg" alt="Capa do documentário: O dilema das Redes">
                <a href="https://www.netflix.com/br/title/81254224" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Netflix
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do Documentário <br> "O dilema das redes"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/uaaC57tcci0?si=U-9FiBYd1meg6zoS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-odilemadasredes2.jpg" alt="Retrato de usuário utilizando redes sociais">
                    <a href="https://www.netflix.com/br/title/81254224" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Netflix
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/documentarios/citizenfour.php"; ?>
