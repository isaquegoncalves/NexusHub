...
<title>Original Netflix: The Great Hack - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            ...
            <p>"The Great Hack" é um documentário revelador que explora o escândalo da Cambridge Analytica, expondo a manipulação de dados pessoais e suas implicações na democracia moderna.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 11/06/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-thegreathack.jpg" alt="Capa do documentário: the great hack">
                <a href="https://www.netflix.com/br/title/80117542?source=35" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Netflix
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do documetário<br> "The Great Hack"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/wjXYCrxRWqc?si=R4Ba-m_4t44RgjSS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-thegreathack2.jpg" alt="cena fictícia representando os dados de redes sociais">
                    <a href="https://www.netflix.com/br/title/80117542?source=35" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Netflix
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/documentarios/lo-and-be-hold.php"; ?>
