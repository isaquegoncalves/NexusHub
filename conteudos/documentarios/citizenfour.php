...
<title>Sobre Citizenfour - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>Citizenfour</h2>
            <p>"Citizenfour" é um documentário instigante que narra os eventos em torno das revelações de Edward Snowden sobre a vigilância em massa conduzida pelo governo dos Estados Unidos.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 09/06/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-citizenfour.jpg" alt="Capa do documentário: citizenfour">
                <a href="https://www.primevideo.com/-/pt/detail/Citizenfour/0TIXEDXS5NHRRNY1DHKCG0FHLL" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Prime Video
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do Documentários<br> "Citizenfour"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/jxZ3tC0SN9s?si=KdOtIt_ZoNWIK7qy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-citizenfour2.jpeg" alt="ator principal do documetário">
                    <a href="https://www.primevideo.com/-/pt/detail/Citizenfour/0TIXEDXS5NHRRNY1DHKCG0FHLL" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Prime Video
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <article>
                ...
                <p>
                    "Citizenfour" não apenas informa, mas também inspira e desafia o público a considerar as implicações de viver em uma sociedade onde a privacidade pode ser facilmente comprometida. É um documentário que permanece relevante e impactante, ressaltando a necessidade de vigilância e proteção dos direitos individuais em um mundo cada vez mais monitorado.
                </p>
            </article>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/documentarios/o-dilema-das-redes.php"; ?>
            <?php include_once "../../scripts/php/articles_veja-mais/documentarios/the-great-hack.php"; ?>
            <?php include_once "../../scripts/php/articles_veja-mais/documentarios/terms-and-conditions-may-apply.php"; ?>
