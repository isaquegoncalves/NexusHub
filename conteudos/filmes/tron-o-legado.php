...
<title>Análise geral sobre "Tron: O Legado" - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>Tron: O Legado</h2>
            <p>"Tron: O Legado" é uma sequência visualmente impressionante que transporta os espectadores para o mundo digital da Grade, com uma história repleta de ação e nostalgia.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 07/06/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-tronolegado.png" alt="Poster do filme Tron O legado">
                <a href="https://www.disneyplus.com/pt-br/movies/tron-o-legado/blTc6WOlDg44" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Disney+
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do filme<br> "Tron: O Legado"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/JgzAZdK7uWQ?si=Md7PZ8s9vPZSZMxT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-tronolegado2.webp" alt="Cenário de uma batalha digital do filme">
                    <a href="https://www.disneyplus.com/pt-br/movies/tron-o-legado/blTc6WOlDg44" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Disney+
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/filmes/oblivion.php" ?>
