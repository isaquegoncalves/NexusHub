...
<title>Conheça "Resistência" - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>Resistência</h2>
            <p>"Resistência" é um thriller de ficção científica onde humanos lutam contra uma inteligência artificial rebelde que ameaça exterminar a humanidade. A história explora temas de sobrevivência e moralidade em um futuro distópico.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 28/06/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-resistencia.jpg" alt="poster do filme resistencia">
                <a href="https://www.disneyplus.com/pt-br/movies/resistencia/72mEvQRMGZ3n" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Disney+
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do filme<br> "Resistência"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/UmXARrHrW30?si=Tsppn7MbDyWp4cJf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-resistencia2.jpg" alt="Robô humanoide controlado por inteligência artificial segurando um fuzil">
                    <a href="https://www.disneyplus.com/pt-br/movies/resistencia/72mEvQRMGZ3n" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Disney+
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/filmes/deep-web-o-show-da-morte.php"; ?>

            <?php include_once "../../scripts/php/articles_veja-mais/filmes/blade-runner2049.php"; ?>

            <?php include_once "../../scripts/php/articles_veja-mais/filmes/the-social-network.php"; ?>
