...
<title>Analisando "O Vingador do Futuro" - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>O Vingador do Futuro</h2>
            <p>"O Vingador do Futuro" (2012) é uma releitura emocionante do clássico de ficção científica, apresentando uma trama envolvente, efeitos visuais impressionantes e performances cativantes.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 07/06/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-ovigadordofuturo.jpg" alt="poster do filme O Vingador do futuro">
                <a href="https://www.primevideo.com/dp/amzn1.dv.gti.12bc4258-0575-e983-1155-637200b14a10?autoplay=0&ref_=atv_cf_strg_wb" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Prime Video
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do filme<br> "O Vingador do Futuro"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/EOQ78IBGkAg?si=8T69Kl_QxyzAicz9" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-ovigadordofuturo2.jpg" alt="cena do protagonista do filme">
                    <a href="https://www.primevideo.com/dp/amzn1.dv.gti.12bc4258-0575-e983-1155-637200b14a10?autoplay=0&ref_=atv_cf_strg_wb" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Prime Video
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/filmes/blade-runner2049.php"; ?>

            <?php include_once "../../scripts/php/articles_veja-mais/filmes/resistencia.php"; ?>

            <?php include_once "../../scripts/php/articles_veja-mais/filmes/o-preco-do-amanha.php"; ?>
