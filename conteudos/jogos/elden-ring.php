...
<title>Universo de Elden Ring - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>Elden Ring</h2>
            <p>
                O jogo se passa em um vasto mundo aberto conhecido como as Terras Intermédias, onde os jogadores devem restaurar o Elden Ring e se tornar o Senhor Prístino, enfrentando inimigos formidáveis e desvendando mistérios antigos.
            </p>

            <p class="nome-data">Por Isaque G. S. Brandão | 03/07/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-elden-ring.webp" alt="poster do jogo elden ring">
                <a href="https://en.bandainamcoent.eu/elden-ring/elden-ring" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Bandai Namco
                <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do jogo<br> "Elden Ring"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/E3Huy2cdih0?si=oMmanOw85FIWQgiH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-elden-ring2.webp" alt="criatura fictícia presente em elden ring">
                    <a href="https://en.bandainamcoent.eu/elden-ring/elden-ring" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Bandai Namco
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
