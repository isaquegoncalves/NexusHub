...
<title>Review dos "Guardians of the Galaxy" - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            ...
            <p>Um jogo de ação e aventura onde os jogadores controlam Peter Quill (Senhor das Estrelas) e lideram os Guardiões da Galáxia em uma nova e emocionante missão para salvar o universo.</p>

            <p class="nome-data">Por Isaque G. S. Brandão | 01/07/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-guardioesdagalaxia.avif" alt="poster do jogo Guardiões da Galáxia">
                <a href="https://www.eidosmontreal.com/games/marvels-guardians-of-the-galaxy/" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Eidos Interactive
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do jogo<br> "Guardians of the Galaxy"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/NCP9g8cjp-o?si=NCYpTdj3Dr0DRDz_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-guardioesdagalaxia2.avif" alt="espaço-nave dos Guardiões da galaxia">
                    <a href="https://www.eidosmontreal.com/games/marvels-guardians-of-the-galaxy/" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Eidos Interactive
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/jogos/star-wars-battlefront2.php"; ?>
