...
<title>Tudo sobre o novo "Life is Strange Double Exposure" - NexusHub</title>
...
<body>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            <h2>Life is Strange: <br> Double Exposure</h2>
            <p>Max Caulfield retorna em "Life is Strange: Double Exposure", onde deve resolver e prevenir o assassinato de sua nova amiga Safi navegando entre duas realidades paralelas.
            </p>

            <p class="nome-data">Por Isaque G. S. Brandão | 28/06/2024</p>

            <div class="poster-conteudo">
                <img src="../../design/img/banner-lisdoubleexposure.jpg" alt="poster do jogo life is strange double exposure">
                <a href="https://deckninegames.com" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Deck Nine
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer de jogo<br> "Life is Strange Double Exposure"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Ciia3eBFnb8?si=yG_hO9Xcz5Hr9E2O" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/jogos/lost-records-bloom&rage.php"; ?>
