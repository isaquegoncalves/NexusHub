...
<title>Tudo sobre o novo Black Ops 6 - NexusHub</title>
    ...
    <main>
        ...
        <div id="col-2"> <!--Conteúdo Principal-->
            ...
            <div class="poster-conteudo">
                ...
                <a href="https://www.callofduty.com/br/pt/blackops6" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Activision
                    <sup>
            ...
            <h2 class="titulo-article-conteudo" style="text-align: center; margin: 0px;">
                Trailer do filme<br> "Call of Duty: Black Ops 6"
            </h2>

            <div class="poster-iframe">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/oyZY_BiTmd8?si=PYnVTbyQesz8fEPW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            ...
            <article>
                ...
                <div class="poster-conteudo">
                    <img src="../../design/img/banner-blackops62.jpg" alt="poster do jogo black ops 6">
                    <a href="https://www.callofduty.com/br/pt/blackops6" class="creditos" target="_blank" rel="noopener noreferrer">Fonte: Activision
                        <sup>
                            <i class="fa-solid fa-link"></i>
                        </sup>
            ...
            <?php include_once "../../scripts/php/articles_veja-mais/jogos/gta6.php"; ?>
